...
DEPLOY_PATH=C:/Users/jhguyb/sugar/workspace/github/maven-repository/
CURRENT_PATH=`pwd`
...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy -Dmaven.test.skip  -DaltDeploymentRepository=self-mvn-repo::default::file:C:/Users/jhguyb/sugar/workspace/github/maven-repository/repository
